...
### ⏱️ Partie 1 : Contexte & Enjeux (Slides 1 à 9) - Cible : 3 min 30s
...
*   **Transition :** *"Pour relever ces défis en 20 semaines, nous avons planifié nos sprints."*
...
*   **Transition :** *"Voyons maintenant comment le Deep Learning répond à ces verrous technologiques."*

---

### ⏱️ Partie 2 : Modélisation Deep Learning (Slides 10 à 18) - Cible : 5 min 30s

#### Slide 10 : L'avènement du Deep Learning pour le NIDS (35s)
*   **Speech :**
...
*   **Transition :** *"Pour entraîner et évaluer nos architectures, nous avons utilisé un jeu de données de référence."*
...
*   **Speech :**
    > *"Chaque flux réseau est identifié de manière bidirectionnelle par son quintuplet standard : les IPs et ports Source et Destination, ainsi que le protocole. Le port de destination est essentiel car il cible le service visé. Nous analysons également les drapeaux TCP comme SYN ou RST pour identifier les scans. Sur les 77 variables de flux extraites par NFStream, nous exploitons des données temporelles comme la durée de flux (moyenne de 16 secondes), des données volumétriques comme la taille totale des paquets retournés, et des variables de débits comme le nombre de paquets par seconde."*
*   **Cues visuels :** Pointez le Quintuplet à gauche, les drapeaux TCP (Flags) en bas à gauche, puis les statistiques réelles à droite (IAT, Volumétrie, Débits).
